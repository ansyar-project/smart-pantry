...
export const metadata: Metadata = {
  title:
    "Smart Pantry - Reduce Food Waste by 40% with Intelligent Inventory Tracking",
  description:
    "Join thousands of users reducing food waste with Smart Pantry. Track inventory with barcode scanning, get expiry alerts, and discover personalized recipes. Start your sustainable kitchen journey today - free forever.",
  keywords: [
    "reduce food waste",
    "smart pantry app",
  ...
  openGraph: {
    title:
      "Smart Pantry - Reduce Food Waste by 40% with Intelligent Inventory Tracking",
    description:
      "Join thousands of users reducing food waste with Smart Pantry. Track inventory, get expiry alerts, and discover personalized recipes.",
    type: "website",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "Smart Pantry app dashboard showing food inventory tracking and recipe recommendations",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Smart Pantry - Reduce Food Waste by 40%",
    description:
      "Track inventory, get expiry alerts, and discover personalized recipes. Start your sustainable kitchen journey today.",
  },
  alternates: {
    canonical: "/",
  },
...
export default async function HomePage() {
  ...
  const structuredData = {
    ...
    name: "Smart Pantry",
    description:
      "Intelligent food management and recipe discovery application that helps reduce food waste",
    ...
    featureList: [
      ...
      "Smart expiry date alerts and notifications",
      "Personalized recipe recommendations based on available ingredients",
      "Food waste reduction analytics and insights",
